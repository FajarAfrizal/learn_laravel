                    ...
                    <main class="form-register">
                        <form action="/register" method="POST">
                           @csrf
                            ...
                            <div class="form-floating">
                                <input type="text" name="a_sekolah" class="form-control mt-2" id="tgl_lahir" placeholder="Tanggal Lahir">
                                <label for="tgl_lahir ">Tanggal Lahir</label>
                            </div>
                        ...
                        <small class="d-block text-center mt-3">Silahkan Masukan Email dan Password</small>
                    </main>
                </div>
            </div>
        </div>
